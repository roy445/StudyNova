...
export function WordDetailSheet({ wordId, preview, onClose }: { wordId: string | null; preview?: WordPreview | null; onClose: () => void }) {
  ...
  const examples = visibleExamples.length ? visibleExamples : aiExamples;
