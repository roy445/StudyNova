...
export const questionImportJobs = pgTable(
  "question_import_jobs",
  {
    ...
    analysisTotalChunks: integer("analysis_total_chunks").notNull().default(0),
    analysisProcessedChunks: integer("analysis_processed_chunks").notNull().default(0),
    analysisStartedAt: timestamp("analysis_started_at", { withTimezone: true }),
    analysisLastChunkAt: timestamp("analysis_last_chunk_at", { withTimezone: true }),
...
export const dailyKnowledgeItems = pgTable(
  "daily_knowledge_items",
  {
    ...
    licenseInfo: text("license_info").notNull().default(""),
