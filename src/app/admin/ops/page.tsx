...
export default function AdminOpsPage() {
  ...
  async function startBankImport(files: File[], mode: "manual" | "auto") {
    ...
    try {
      ...
      const created = await apiPost<{ jobId: string }>("/admin/question-imports", { totalFiles: files.length, bankCategory: category, sourceLabel: source, targetBank: bankUploadMeta.target });
