...
export const ERROR_CATALOG = {
  ...
  CHRISTMAS_REINDEER_TOKEN_INVALID: def("SN-NOVA-5013", 400, "NOVA", "馴鹿事件驗證失敗", "請等待下一隻馴鹿出現後再試。"),
  CHRISTMAS_REINDEER_TOKEN_EXPIRED: def("SN-NOVA-5014", 400, "NOVA", "馴鹿已飛遠", "馴鹿獎勵只能在出現後短時間內領取。"),
  CHRISTMAS_REINDEER_DISABLED: def("SN-NOVA-5015", 403, "NOVA", "馴鹿活動目前未開放", "請等待管理員重新開啟聖誕馴鹿活動。"),
  ...
  IMAGE_INVALID: def("SN-AI-6010", 400, "AI", "圖片檔案無法讀取", "請改用有效的 JPG、PNG 或 WebP 圖片後重試。"),
  IMAGE_TOO_LARGE: def("SN-AI-6011", 413, "AI", "圖片檔案過大", "請壓縮圖片後再上傳，單張圖片不可超過 12MB。"),
  ...
  ADMIN_TEXTBOOK_REQUEST_INVALID: def("SN-ADMIN-9510", 400, "ADMIN", "教材資料格式不正確", "請確認教育階段、科目、出版社與教材欄位後再試。"),
  ADMIN_TEXTBOOK_DB_ERROR: def("SN-ADMIN-9511", 500, "ADMIN", "教材資料儲存失敗", "請稍後再試；若持續發生，請提供錯誤代碼與追蹤編號。"),
