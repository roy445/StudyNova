...
**AI 學習平台 + 個人學習管理 + 成績分析 + 教材分析 + OCR + 錯題 + 測驗 + 錄音分析 + 每週補習小考 + 社交分享 + Novi AI 助理 + Nova 養成 + 管理後台**。
...
| 每週補習小考 | 週次管理、考卷／答案分開上傳、螢光筆語意設定、AI OCR + 題答配對草稿、管理員人工確認才發布、10 分鐘快速複習、模擬測驗、統計與排名、歷史週次永久保存與重新開放 |
